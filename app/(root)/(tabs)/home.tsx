...
import GoogleTextInput from '@/components/GoogleTestInput';
...
const Home = () => {
    ...
    useEffect(() => {
        const requestLocationPermission = async () => {
            ...
            setUserLocation({ latitude: location.coords.latitude, longitude: location.coords.longitude, address: `${address[0].name}, ${address[1].name}` })
        }
